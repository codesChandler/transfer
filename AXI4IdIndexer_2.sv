...
module AXI4IdIndexer_2(
  ...
  input  [8:0]  auto_in_aw_bits_id,	// src/main/scala/diplomacy/LazyModule.scala:374:18
  ...
  output [8:0]  auto_in_b_bits_id,	// src/main/scala/diplomacy/LazyModule.scala:374:18
  ...
  input  [8:0]  auto_in_ar_bits_id,	// src/main/scala/diplomacy/LazyModule.scala:374:18
  ...
  output [8:0]  auto_in_r_bits_id,	// src/main/scala/diplomacy/LazyModule.scala:374:18
  ...
  output [8:0]  auto_out_aw_bits_echo_tl_state_source,	// src/main/scala/diplomacy/LazyModule.scala:374:18
  output [4:0]  auto_out_aw_bits_echo_extra_id,	// src/main/scala/diplomacy/LazyModule.scala:374:18
  ...
  input  [8:0]  auto_out_b_bits_echo_tl_state_source,	// src/main/scala/diplomacy/LazyModule.scala:374:18
  input  [4:0]  auto_out_b_bits_echo_extra_id,	// src/main/scala/diplomacy/LazyModule.scala:374:18
  ...
  output [8:0]  auto_out_ar_bits_echo_tl_state_source,	// src/main/scala/diplomacy/LazyModule.scala:374:18
  output [4:0]  auto_out_ar_bits_echo_extra_id,	// src/main/scala/diplomacy/LazyModule.scala:374:18
  ...
  input  [8:0]  auto_out_r_bits_echo_tl_state_source,	// src/main/scala/diplomacy/LazyModule.scala:374:18
  input  [4:0]  auto_out_r_bits_echo_extra_id,	// src/main/scala/diplomacy/LazyModule.scala:374:18
  input         auto_out_r_bits_last	// src/main/scala/diplomacy/LazyModule.scala:374:18
);

  wire        auto_in_aw_valid_0 = auto_in_aw_valid;
  wire [8:0]  auto_in_aw_bits_id_0 = auto_in_aw_bits_id;
  ...
  wire [8:0]  auto_in_ar_bits_id_0 = auto_in_ar_bits_id;
  ...
  wire [8:0]  auto_out_b_bits_echo_tl_state_source_0 =
    auto_out_b_bits_echo_tl_state_source;
  wire [4:0]  auto_out_b_bits_echo_extra_id_0 = auto_out_b_bits_echo_extra_id;
  ...
  wire [8:0]  auto_out_r_bits_echo_tl_state_source_0 =
    auto_out_r_bits_echo_tl_state_source;
  wire [4:0]  auto_out_r_bits_echo_extra_id_0 = auto_out_r_bits_echo_extra_id;
  ...
  wire [8:0]  nodeIn_aw_bits_id = auto_in_aw_bits_id_0;	// src/main/scala/diplomacy/Nodes.scala:1214:17
  ...
  wire [8:0]  nodeIn_b_bits_id;	// src/main/scala/diplomacy/Nodes.scala:1214:17
  ...
  wire [8:0]  nodeIn_ar_bits_id = auto_in_ar_bits_id_0;	// src/main/scala/diplomacy/Nodes.scala:1214:17
  ...
  wire [8:0]  nodeIn_r_bits_id;	// src/main/scala/diplomacy/Nodes.scala:1214:17
  ...
  wire [8:0]  nodeOut_aw_bits_echo_tl_state_source;	// src/main/scala/diplomacy/Nodes.scala:1205:17
  wire [4:0]  nodeOut_aw_bits_echo_extra_id;	// src/main/scala/diplomacy/Nodes.scala:1205:17
  ...
  wire [8:0]  nodeOut_b_bits_echo_tl_state_source =
    auto_out_b_bits_echo_tl_state_source_0;	// src/main/scala/diplomacy/Nodes.scala:1205:17
  wire [4:0]  nodeOut_b_bits_echo_extra_id = auto_out_b_bits_echo_extra_id_0;	// src/main/scala/diplomacy/Nodes.scala:1205:17
  ...
  wire [8:0]  nodeOut_ar_bits_echo_tl_state_source;	// src/main/scala/diplomacy/Nodes.scala:1205:17
  wire [4:0]  nodeOut_ar_bits_echo_extra_id;	// src/main/scala/diplomacy/Nodes.scala:1205:17
  ...
  wire [8:0]  nodeOut_r_bits_echo_tl_state_source =
    auto_out_r_bits_echo_tl_state_source_0;	// src/main/scala/diplomacy/Nodes.scala:1205:17
  wire [4:0]  nodeOut_r_bits_echo_extra_id = auto_out_r_bits_echo_extra_id_0;	// src/main/scala/diplomacy/Nodes.scala:1205:17
  ...
  wire [8:0]  auto_in_b_bits_id_0 = nodeIn_b_bits_id;	// src/main/scala/diplomacy/Nodes.scala:1214:17
  ...
  wire [8:0]  auto_in_b_bits_echo_tl_state_source_0 = nodeIn_b_bits_echo_tl_state_source;	// src/main/scala/diplomacy/Nodes.scala:1214:17
  ...
  wire [8:0]  auto_in_r_bits_id_0 = nodeIn_r_bits_id;	// src/main/scala/diplomacy/Nodes.scala:1214:17
  ...
  wire [8:0]  auto_in_r_bits_echo_tl_state_source_0 = nodeIn_r_bits_echo_tl_state_source;	// src/main/scala/diplomacy/Nodes.scala:1214:17
  ...
  wire [8:0]  auto_out_aw_bits_echo_tl_state_source_0 =
    nodeOut_aw_bits_echo_tl_state_source;	// src/main/scala/diplomacy/Nodes.scala:1205:17
  wire [4:0]  auto_out_aw_bits_echo_extra_id_0 = nodeOut_aw_bits_echo_extra_id;	// src/main/scala/diplomacy/Nodes.scala:1205:17
  ...
  wire [8:0]  auto_out_ar_bits_echo_tl_state_source_0 =
    nodeOut_ar_bits_echo_tl_state_source;	// src/main/scala/diplomacy/Nodes.scala:1205:17
  wire [4:0]  auto_out_ar_bits_echo_extra_id_0 = nodeOut_ar_bits_echo_extra_id;	// src/main/scala/diplomacy/Nodes.scala:1205:17
  ...
  assign nodeOut_ar_bits_echo_extra_id = nodeIn_ar_bits_id[8:4];	// src/main/scala/amba/axi4/IdIndexer.scala:83:56, src/main/scala/diplomacy/Nodes.scala:1205:17, :1214:17
  assign nodeOut_aw_bits_echo_extra_id = nodeIn_aw_bits_id[8:4];	// src/main/scala/amba/axi4/IdIndexer.scala:84:56, src/main/scala/diplomacy/Nodes.scala:1205:17, :1214:17
