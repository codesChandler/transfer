...
module IBuf(
  ...
  wire [1:0]   nIC =
    (io_imem_bits_btb_taken_0 ? {1'h0, io_imem_bits_btb_bridx_0} + 2'h1 : 2'h2) - _GEN;	// src/main/scala/rocket/IBuf.scala:34:47, :41:{16,64,86}, :92:63
  ...
  wire [1:0]   nValid = (io_imem_valid_0 ? nIC : 2'h0) + _GEN_0;	// src/main/scala/rocket/IBuf.scala:40:27, :41:86, :42:25, :43:{19,45}
  ...
  wire [1:0]   ic_replay =
    buf_replay_0 | (io_imem_bits_replay_0 ? valid & ~bufMask : 2'h0);	// src/main/scala/rocket/IBuf.scala:40:27, :74:39, :75:37, :77:23, :78:{30,35,63,65}
  ...
  assign replay = ic_replay[0] | ~_exp_io_rvc & ic_replay[1];	// src/main/scala/rocket/IBuf.scala:41:64, :78:30, :86:21, :92:{29,33,37,49,61}
  ...
  always @(posedge clock) begin
    ...
    if (io_inst_0_ready_0 & _GEN_2) begin	// src/main/scala/rocket/IBuf.scala:35:16, :47:29, :54:{68,94}, :57:13
      ...
      buf_pc <=
        ...
        & 40'h3;	// src/main/scala/rocket/IBuf.scala:34:47, :35:16, :42:25, :59:{35,37,49,68,109}
