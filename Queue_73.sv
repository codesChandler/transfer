...
module Queue_73(
  ...
  input  [8:0]  io_enq_bits_id,	// src/main/scala/chisel3/util/Decoupled.scala:273:14
  ...
  input  [8:0]  io_enq_bits_echo_tl_state_source,	// src/main/scala/chisel3/util/Decoupled.scala:273:14
  ...
  output [8:0]  io_deq_bits_id,	// src/main/scala/chisel3/util/Decoupled.scala:273:14
  ...
  output [8:0]  io_deq_bits_echo_tl_state_source,	// src/main/scala/chisel3/util/Decoupled.scala:273:14
  output        io_deq_bits_wen	// src/main/scala/chisel3/util/Decoupled.scala:273:14
);

  wire        io_enq_valid_0 = io_enq_valid;
  wire [8:0]  io_enq_bits_id_0 = io_enq_bits_id;
  ...
  wire [8:0]  io_enq_bits_echo_tl_state_source_0 = io_enq_bits_echo_tl_state_source;
  ...
  wire        io_enq_bits_lock = 1'h0;	// src/main/scala/chisel3/util/Counter.scala:61:73, src/main/scala/chisel3/util/Decoupled.scala:273:14, :274:95, :327:32
  wire        enq_ptr_value = 1'h0;	// src/main/scala/chisel3/util/Counter.scala:61:73, src/main/scala/chisel3/util/Decoupled.scala:273:14, :274:95, :327:32
  wire        deq_ptr_value = 1'h0;	// src/main/scala/chisel3/util/Counter.scala:61:73, src/main/scala/chisel3/util/Decoupled.scala:273:14, :274:95, :327:32
  wire        ptr_diff = 1'h0;	// src/main/scala/chisel3/util/Counter.scala:61:73, src/main/scala/chisel3/util/Decoupled.scala:273:14, :274:95, :327:32
  reg  [79:0] ram;	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [8:0]  io_deq_bits_id_0 = ram[8:0];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [31:0] io_deq_bits_addr_0 = ram[40:9];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [7:0]  io_deq_bits_len_0 = ram[48:41];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [2:0]  io_deq_bits_size_0 = ram[51:49];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [1:0]  io_deq_bits_burst_0 = ram[53:52];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire        io_deq_bits_lock_0 = ram[54];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [3:0]  io_deq_bits_cache_0 = ram[58:55];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [2:0]  io_deq_bits_prot_0 = ram[61:59];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [3:0]  io_deq_bits_qos_0 = ram[65:62];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [3:0]  io_deq_bits_echo_tl_state_size_0 = ram[69:66];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire [8:0]  io_deq_bits_echo_tl_state_source_0 = ram[78:70];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  wire        io_deq_bits_wen_0 = ram[79];	// src/main/scala/chisel3/util/Decoupled.scala:274:95
  ...
  always @(posedge clock) begin
    ...
    if (reset)
      maybe_full <= 1'h0;	// src/main/scala/chisel3/util/Counter.scala:61:73, src/main/scala/chisel3/util/Decoupled.scala:273:14, :274:95, :277:27, :327:32
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        ram = {_RANDOM[2'h0][31:1], _RANDOM[2'h1], _RANDOM[2'h2][16:0]};	// src/main/scala/chisel3/util/Decoupled.scala:274:95
