...
module TLBuffer_10(
  ...
  output [3:0]  auto_in_d_bits_sink,	// src/main/scala/diplomacy/LazyModule.scala:374:18
  ...
  input  [3:0]  auto_in_e_bits_sink,	// src/main/scala/diplomacy/LazyModule.scala:374:18
  ...
  wire [3:0]  auto_in_e_bits_sink_0 = auto_in_e_bits_sink;
  ...
  wire [3:0]  nodeIn_e_bits_sink = auto_in_e_bits_sink_0;	// src/main/scala/diplomacy/Nodes.scala:1214:17
  ...
  wire [3:0]  auto_in_d_bits_sink_0 = nodeIn_d_bits_sink;	// src/main/scala/diplomacy/Nodes.scala:1214:17
  ...
  TLMonitor_40 monitor (	// src/main/scala/tilelink/Nodes.scala:24:25
    .clock                (clock),
    .reset                (reset),
  ...
  Queue_124 nodeOut_a_q (	// src/main/scala/chisel3/util/Decoupled.scala:376:21
    .clock               (clock),
    .reset               (reset),
  ...
  Queue_125 nodeIn_d_q (	// src/main/scala/chisel3/util/Decoupled.scala:376:21
    .clock               (clock),
    .reset               (reset),
  ...
  Queue_126 nodeIn_b_q (	// src/main/scala/chisel3/util/Decoupled.scala:376:21
    .clock               (clock),
    .reset               (reset),
    .io_enq_ready        (nodeOut_b_ready),
    .io_enq_valid        (nodeOut_b_valid),	// src/main/scala/diplomacy/Nodes.scala:1205:17
    .io_enq_bits_opcode  (nodeOut_b_bits_opcode),	// src/main/scala/diplomacy/Nodes.scala:1205:17
    .io_enq_bits_param   (nodeOut_b_bits_param),	// src/main/scala/diplomacy/Nodes.scala:1205:17
    .io_enq_bits_size    (nodeOut_b_bits_size),	// src/main/scala/diplomacy/Nodes.scala:1205:17
    ...
    .io_enq_bits_mask    (nodeOut_b_bits_mask),	// src/main/scala/diplomacy/Nodes.scala:1205:17
  ...
  Queue_127 nodeOut_c_q (	// src/main/scala/chisel3/util/Decoupled.scala:376:21
    .clock               (clock),
    .reset               (reset),
  ...
  Queue_128 nodeOut_e_q (	// src/main/scala/chisel3/util/Decoupled.scala:376:21
    .clock            (clock),
    .reset            (reset),
